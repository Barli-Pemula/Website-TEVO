...
export default function IdentitySection() {
  return (
    <section id="identity" className="relative bg-smoke py-24 md:py-32">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <motion.p
          ...
          className="mt-3 text-lg md:text-xl text-bark italic font-[family-name:var(--font-editorial)]"
        >
          &ldquo;{PLACEHOLDER.identity.slogan}&rdquo;
        </motion.p>
